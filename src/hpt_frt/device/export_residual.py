...
# frt-v1 training artifact (moved to legacy_pre_audit by the 2026-06-22 governance pass); used only
# to pick the higher-scoring checkpoint. This export is the legacy pipeline, pending P3 retrain.
TRAIN_JSON = LAB / 'results' / 'legacy_pre_audit' / 'residual_train.json'
