function validate_dq_variants2()
...
modes=[7 12]; mlab={'dq-Song+cap0.27','SAC-mode12-current'};
...
% ================= summary =================
save('../results/dq_variants2_compare.mat','R','mlab');
fid=fopen('../results/dq_variants2_compare.txt','w');
...
fclose(fid); fprintf('\nsaved ../results/dq_variants2_compare.{mat,txt}\n');
end
