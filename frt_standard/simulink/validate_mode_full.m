...
%   MD : HLC mode (e.g. 7 strongest fixed law, 8 MPC, 13 hybrid)
...
out=sprintf('../results/frt320_m%d_%s',MD,FT);
results=struct([]);
...
if strcmp(FT,'hvrt')
  ...
  for i=1:N
    ...
    if mod(i,10)==0, save([out '_partial.mat'],'results','i'); end
  end
else
