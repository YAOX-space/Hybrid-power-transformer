...
% Plots 6 controllers MODES=[4 7 8 12 13 14] (incl. m14 residual-SAC, the 96.3% champion).
%  1 fig_all_320_bar.png    per-domain FRT bars, 6 controllers, from frt320_m*_*.mat (real data)
%  2 fig_all_criteria.png   criterion-level bars (LVRT 240 + HVRT 80), 6 controllers
